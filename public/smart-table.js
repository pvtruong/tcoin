...
ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
    $templateCache.put('template/smart-table/pagination.html',
        ...
        '<li ng-repeat="page in pages" ng-class="{active: page==currentPage}" class="page-item"><a href="#" class="page-link" ng-click="selectPage(page); $event.preventDefault(); $event.stopPropagation();">{{page}}</a></li>' +
        '</ul></nav>');
}]);
